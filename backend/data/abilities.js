...
export const Abilities = {
  ...
  airlock: {
    onSwitchIn(pokemon) {
      ...
      if (this.effect && typeof this.effect.onStart === "function") {
  ...
  commander: {
    ...
    onAnySwitchIn() {
      if (this.effect && typeof this.effect.onUpdate === "function") {
  ...
  iceface: {
    ...
    onWeatherChange(pokemon, source, sourceEffect) {
      ...
      if (sourceEffect && sourceEffect.suppressWeather) return;
      if (!pokemon.hp) return;
      if (
        this.field.isWeather(["hail", "snowscape"]) &&
        pokemon.species.id === "eiscuenoice"
  ...
  opportunist: {
    onFoeAfterBoost(boost, target, source, effect) {
      if (
        effect &&
        (effect.name === "Opportunist" || effect.name === "Mirror Herb")
      )
        return;
  ...
  pastelveil: {
    ...
    onAnySwitchIn() {
      if (this.effect && this.effect.onStart) {
  ...
  ripen: {
    onTryHeal(damage, target, source, effect) {
      ...
      if (effect && effect.isBerry) return this.chainModify(2);
    },
    onChangeBoost(boost, target, source, effect) {
